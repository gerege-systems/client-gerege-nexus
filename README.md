...
| Модуль | Юу | Хэзээ ирсэн |
| --- | --- | --- |
| `egov` | ХУР-ын лавлагаа, төрийн сувгийн төлөв, лавлагааны түүх | 2026-08-23 |

`egov` нь цөмд байхдаа `internal/platform/gerege`-ээс ХУР-ын клиентийг,
`audit_events` хүснэгтээс лавлагааны түүхээ шууд уншдаг байсан. Хоёулаа одоо
SDK-гийн гэрээ: `nexus.StateRegistry` ба `nexus.AuditReader`. Модуль
өгөгдлийн сан огт хэрэглэдэггүй — төрөөс асууж, асуусан гэдгээ платформоор
санамсарлуулна.
...
| Модуль | `egov` — Цахим засгийн холболт. 2026-08-23-нд цөмөөс энд нүүсэн |
