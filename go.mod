module github.com/gerege-systems/client-gerege-nexus

go 1.26

require (
	github.com/gerege-systems/open-gerege-core v1.10.0
	github.com/gerege-systems/open-gerege-nexus/backend v1.15.0
...
// sums for it. This product's own code never imports it — it is a main
