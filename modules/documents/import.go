...
func readRecipientRows(file io.Reader, filename string) ([]recipientRow, error) {
	...
	case ".xlsx":
		...
		if err != nil {
			return nil, fmt.Errorf("хавсаргасан Excel файл уншигдсангүй: %v", err)
		}
		defer func() { _ = book.Close() }()
		sheets := book.GetSheetList()
		if len(sheets) == 0 {
			return nil, fmt.Errorf("хавсаргасан Excel файлд хуудас алга")
		}
		...
		if err != nil {
			return nil, fmt.Errorf("хүснэгтийн мөрүүд уншигдсангүй: %v", err)
		}
		for it.Next() {
